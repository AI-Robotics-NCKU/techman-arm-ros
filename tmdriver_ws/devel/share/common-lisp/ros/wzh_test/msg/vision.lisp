...
(cl:defmethod cl:initialize-instance :after ((m <vision>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vision)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wzh_test-msg:<vision> is deprecated: use wzh_test-msg:vision instead.")))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_test-msg:pitch-val is deprecated.  Use wzh_test-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_test-msg:yaw-val is deprecated.  Use wzh_test-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_test-msg:roll-val is deprecated.  Use wzh_test-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_test-msg:distance-val is deprecated.  Use wzh_test-msg:distance instead.")
  (distance m))
