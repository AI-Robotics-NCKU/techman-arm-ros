...
(cl:in-package wzh_set_cordinate_discontinuous-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <vision>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vision)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wzh_set_cordinate_discontinuous-msg:<vision> is deprecated: use wzh_set_cordinate_discontinuous-msg:vision instead.")))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_set_cordinate_discontinuous-msg:pitch-val is deprecated.  Use wzh_set_cordinate_discontinuous-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_set_cordinate_discontinuous-msg:yaw-val is deprecated.  Use wzh_set_cordinate_discontinuous-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_set_cordinate_discontinuous-msg:roll-val is deprecated.  Use wzh_set_cordinate_discontinuous-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <vision>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wzh_set_cordinate_discontinuous-msg:distance-val is deprecated.  Use wzh_set_cordinate_discontinuous-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vision>)))
  ...
  "wzh_set_cordinate_discontinuous/vision")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vision)))
  "Returns string type for a message object of type 'vision"
  "wzh_set_cordinate_discontinuous/vision")
