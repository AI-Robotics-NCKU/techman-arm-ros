...
class FeedbackState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ft_sensor')) {
        this.ft_sensor = initObj.ft_sensor
      }
      else {
        this.ft_sensor = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ft_sensor]
    bufferOffset = _arraySerializer.float64(obj.ft_sensor, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ft_sensor]
    data.ft_sensor = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.ft_sensor.length;
  ...
  static md5sum() {
    ...
    return 'aad84330c476419a0ed376e0cf5a4b9e';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.ft_sensor !== undefined) {
      resolved.ft_sensor = msg.ft_sensor;
    }
    else {
      resolved.ft_sensor = []
    }
