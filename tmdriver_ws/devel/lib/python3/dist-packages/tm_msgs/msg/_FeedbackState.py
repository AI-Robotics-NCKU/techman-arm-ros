...
class FeedbackState(genpy.Message):
  _md5sum = "aad84330c476419a0ed376e0cf5a4b9e"
...
string frame_id
"""
  __slots__ = ['header','is_svr_connected','is_sct_connected','tmsrv_cperr','tmscript_cperr','tmsrv_dataerr','tmscript_dataerr','max_not_connect_in_s','disconnection_times','joint_pos','joint_vel','joint_tor','tool0_pose','tool_pose','tcp_speed','tcp_force','ft_sensor','joint_tor_average','joint_tor_min','joint_tor_max','robot_link','is_data_table_correct','robot_error','project_run','project_pause','safetyguard_a','e_stop','camera_light','error_code','project_speed','ma_mode','robot_light','cb_digital_output','cb_digital_input','cb_analog_output','cb_analog_input','ee_digital_output','ee_digital_input','ee_analog_output','ee_analog_input','error_content']
  _slot_types = ['std_msgs/Header','bool','bool','int32','int32','int32','int32','int32','int32','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','bool','bool','bool','bool','bool','bool','bool','bool','int32','int32','int32','int32','bool[]','bool[]','float32[]','float32[]','bool[]','bool[]','float32[]','float32[]','string']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.ft_sensor)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ft_sensor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.ft_sensor = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ft_sensor.tostring())
      length = len(self.joint_tor_average)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.ft_sensor = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
