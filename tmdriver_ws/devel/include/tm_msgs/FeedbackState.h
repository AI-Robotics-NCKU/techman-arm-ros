...
struct FeedbackState_
{
  ...
  _tcp_force_type tcp_force;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _ft_sensor_type;
  _ft_sensor_type ft_sensor;
...
struct MD5Sum< ::tm_msgs::FeedbackState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xaad84330c476419aULL;
  static const uint64_t static_value2 = 0x0ed376e0cf5a4b9eULL;
};
...
struct Printer< ::tm_msgs::FeedbackState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tm_msgs::FeedbackState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ft_sensor[]" << std::endl;
    for (size_t i = 0; i < v.ft_sensor.size(); ++i)
    {
      s << indent << "  ft_sensor[" << i << "]: ";
      Printer<double>::stream(s, indent + "  ", v.ft_sensor[i]);
    }
