...
{  
  ...
  //Request #標準姿勢 -0.50 0.10 0.4 3.14 0 -1.57
  srv.request.motion_type = tm_msgs::SetPositions::Request::PTP_T;
  srv.request.positions.push_back(-0.50); // 單位 m 
  srv.request.positions.push_back(0.10);
  srv.request.positions.push_back(0.4); 
  srv.request.positions.push_back(3.14); // 單位 pi (3.14)
  srv.request.positions.push_back(0);
  srv.request.positions.push_back(-1.57);
