...
{  
  ...
  double positions[10][6] = {
                            {-0.4,  0.0, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.03, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.06, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.09, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.12, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.15, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.18, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.21, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.24, 0.45, 3.14, 0, -1.57},
                            {-0.4,  0.27, 0.45, 3.14, 0, -1.57},           
                            }; //中點
  ...
  srv_move.request.velocity = 10;//m/s
  srv_move.request.acc_time = 0.2;
  ...
  for( int i=0 ; i<10 ; i=i+1 )
  {
    ...
    // request 往右
    srv_move.request.positions = {positions[i][0], positions[i][1], positions[i][2], positions[i][3], positions[i][4], positions[i][5]};
    client_move.call(srv_move);
